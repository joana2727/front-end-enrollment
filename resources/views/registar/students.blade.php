...
<div class="flex justify-between items-center mb-4 pt-4">
        ...
        <div class="flex space-x-2">
            ...
            <button class="text-sm  text-dark bg-lime-green font-semibold px-4 py-2 rounded-lg hover:bg-primary hover:text-white">IT Courses</button>
            <button class="text-sm text-dark bg-moss-green font-semibold px-4 py-2 rounded-lg hover:bg-primary hover:text-white">CS Courses</button>
        </div>
        <!-- Search Bar Section -->
      <!-- Search Bar Section -->
<div class="relative">
...
<div class="p-5 bg-light rounded-2xl shadow-big w-full mx-auto mb-8">
 ...
 <!-- Title, Year Dropdown, Semester Dropdown, and View All Button -->
