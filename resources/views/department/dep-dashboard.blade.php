...
@section('content')
 <!-- Main Container -->
 <div class="bg-light-gray rounded-lg p-2 flex space-x-6">
    <!-- Instructors Count Section -->
    <div class="bg-white rounded-lg shadow-md p-6 items-center flex flex-row justify-between w-full">
      <!-- Left Section -->
      <div class="w-1/2">
        <h2 class="text-lg font-bold font-family: 'Poppins', sans-serif; text-primary ">Instructors Count</h2>
  ...
  <!-- Table Section -->
<div class="p-5 bg-light rounded-2xl shadow-big w-full mx-auto mb-2" style="margin-top: 10px;">

<!-- Title and View All Button -->
<div class="flex justify-between items-center mb-4">
    <h2 class="font-table-header text-xl">Recently Added Instructors</h2>
